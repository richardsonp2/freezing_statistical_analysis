...
#making the single large dataset high and low shock combined (every animal I have put through the experiment)
# 
# low_ds <- read.csv("./Datasets/experiment1_data.csv")
# combined_ds <- read.csv("./Datasets/combined_table.csv")
# 
# #rename - new_name = old_name no quote marks needed
# low_cleaned <- low_ds %>% 
#   select(3:17) %>% 
#   rename(Pre = pre, Post = post) %>% 
#   relocate(Condition, .after = Sex) %>% 
#   relocate(Cage.no, .before = Stress)
# 
# 
# #figure out how to combine them in R instead of this.
# write.csv(low_cleaned, "./Datasets/low_cleaned.csv", row.names = FALSE)
# write.csv(combined_ds, "./Datasets/combined_ds", row.names = FALSE)
# 
...
#whole script below written for just complete_ds
...
linechart_prepost <- linechart_prepost + scale_color_manual(labels = c("Female ELS", "Female NS", "Male ELS", "Male NS"),values=c("#ff870f", "#ffc182", "#1c20fc", "#b3b4ff"))
...
linechart_prepost <- linechart_prepost + theme(plot.title = element_text(hjust = 0.5),
...
ggsave("PrePost.png", plot = linechart_prepost, path = "./High/Figures/")
...
bar_chart_recall_1 <- bar_chart_recall_1 + scale_x_discrete(labels = c("Male_ELS" = "ELS", "Male_NS" =  "Non-stressed", "Female_ELS" = "ELS", "Female_NS" =  "Non-stressed"))

bar_chart_recall_1 <- bar_chart_recall_1 + scale_fill_manual(labels = c("Male NS", "Male ELS","Female NS", "Female ELS"),values=c("#1c20fc", "#b3b4ff", "#ff870f", "#ffc182"))
...
bar_chart_recall_1 <- bar_chart_recall_1 + theme(plot.title = element_text(hjust = 0.5),
                                                 axis.line = element_blank(),
                                                 panel.grid.minor = element_blank(),
...
extinction_curve_figure <- extinction_curve_figure + scale_color_manual(labels = c("F_ELS" = "Female ELS", "F_NS" = "Female non-stressed", "M_ELS" = "Male ELS", "M_NS" = "Male Non-stressed"),values=c("#ff870f", "#ffc182", "#1c20fc", "#b3b4ff"))
...
#removes gridlines, makes axis lines black
extinction_curve_figure <- extinction_curve_figure + theme(plot.title = element_text(hjust = 0.5),
                                                           axis.line = element_blank(),
                                                           panel.grid.minor = element_blank(),
                                                           panel.grid.major = element_blank(),
                                                           panel.background = element_blank()
...
bar_chart_retval1 <- bar_chart_retval1 + scale_x_discrete(labels = c("Male_ELS" = "ELS", "Male_NS"= "Non-stress", "Female_ELS" = "ELS", "Female_NS" = "Non-stressed"))
...
bar_chart_retval1 <- bar_chart_retval1 + theme(panel.spacing = unit(2,"line"))
...
bar_chart_recall_1_low <- bar_chart_recall_1_low + theme(plot.title = element_text(hjust = 0.5),
                                                 axis.line = element_blank(),
                                                 panel.grid.minor = element_blank(),
                                                 panel.grid.major = element_blank(),
                                                 panel.background = element_blank())
...
#removes gridlines, makes axis lines black
extinction_curve_figure_low <- extinction_curve_figure_low + theme(plot.title = element_text(hjust = 0.5),
                                                           axis.line = element_blank(),
                                                           panel.grid.minor = element_blank(),
                                                           panel.grid.major = element_blank(),
                                                           panel.background = element_blank()
...
bar_chart_retval1_low <- bar_chart_retval1_low + scale_fill_manual(values = c("#ff870f","#1c20fc" ))
